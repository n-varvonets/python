...
"""gen_obj/iter/iter object"""
# - Генератор - поодвид итератора, єлементами которого можно 1)итерироваться и 2)только один раз. Т.е. в генераторе обьекта должна бьіть функция реализована next()
