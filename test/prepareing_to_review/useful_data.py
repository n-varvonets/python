...
# |--------------------------------------------------------|
# WARN:Столбец(или набор стобцоі) значения которого ссьілаются на первичньій ключ другой таблицьі - FK(id_smth), которьій ТАК ЖЕ (2)опеделяют инфу других стоблцов
...
# JOIN-ьі - возможность вьібора данньіх одновременно из нескольких таблиц ((1)ифна клиент и (2)купленньій товар): ("https://ibb.co/9YhrDND")
...
# период(январь) и гурпируем по киленту
